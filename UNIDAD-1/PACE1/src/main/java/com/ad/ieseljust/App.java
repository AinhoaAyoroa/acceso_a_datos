        ...
        do {
            ...
            switch (command) {
                ...
                case "list":
                    ...
                    } else // Si l'ordre indicada és llista, imprimirem tota la info de la Blockchain: els blocs que conté (i els seus propietaris) i cadascuna de les seues transaccions (amb IBAN d'orige, de desti i l'imports associat)
                    {
                        System.out.println(blockchain.toString());
                    }
                    break;
